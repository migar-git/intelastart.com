...
# AGENTS.md — Governed Swarm Assignment: intelastart.com
...
type: static-site
canonical_purpose: Static HTML marketing site â€” services, pricing, blog for IntelaStart
authority_ceiling: 1
```
...
memory:
  ...
  repo_entry_key: intelastart.com
```
...
iteration:
  ...
  branch_pattern: "agency/intelastart.com/{gap_id}"
  pr_title_pattern: "swarm(intelastart.com): {gap_id} — {description}"
